                    ...
                    <div className="container">
                        <div className="row top-area">
                            <div className="col-md-12">
                                <h1>Select <span>5</span> Teams from the Game set Below to make the best Poker-like hands</h1>
                            </div>
                        </div>
                                ...
                                <div className="col-md-6 left_box">
                                    <div className="col-sm-8 boxes-left">
                                        <div className="box-one">
                                            <div className="col-sm-8 al_east">
                                                <p>AL East</p>
                                            </div>
...
export default withRouter(Pickfive);