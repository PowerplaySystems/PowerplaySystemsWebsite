      ...
      <div>
        ...
        <div className="container-fluid _faq_wrap">
          <div className="container">
            <div className="row elite8_live_rows">
              ...
              <div className="col-md-12">
                ...
                <div className="live_draw_winning_box_content">
                  ...
                  >
                    <div className="winning_box_circle_elite8"   style={mCircleStyles}>?</div>
                    <div className="winning_box_circle_elite8"   style={mCircleStyles}>?</div>
                    <div className="winning_box_circle_active" style={mCircleStyles}>13</div>
                    <div className="winning_box_circle_elite8" style={mCircleStyles}>?</div>
                    <div className="winning_box_circle_elite8_active" style={mCircleStyles}>22</div>
                    <div className="winning_box_circle_elite8_active" style={mCircleStyles}>27</div>
                    <div className="winning_box_circle_elite8" style={mCircleStyles}>?</div>
                    <div className="winning_box_circle_elite8" style={mCircleStyles}>?</div>
                  </div>
                </div>
                  ...
                  <div className="live_draw_my_numbers_edit">
                    <div className="mleft">
                      ...
                      <div className="row edit_numbers">
                        <div className="edit_numbers_circle_elite8" style={mCircleStyles}>2</div>
                        <div className="edit_numbers_circle_elite8" style={mCircleStyles}>7</div>
                        <div className="edit_numbers_circle_elite8" style={mCircleStyles}>7</div>
                        <div className="edit_numbers_circle_elite8_active" style = {mLockedCircleStyles}>
                          13
                          <img
                            className="img-responsive"
                        ...
                        <div
                          className="edit_numbers_circle_elite8"
                          style={mCircleStyles}
                        >
                          21
                        </div>
                        ...
                        <div className="edit_numbers_circle_elite8" style={mCircleStyles}>17</div>
                      </div>
