        ...
        <div className="__content __content-3">
          <div className="__wrapper">
            <div className="__container">
              ...
              <div className="__main">
                <div>
                  With Live-Play gaming, you will open up a whole new revenue
                  stream by driving players to your game during live lottery or
                  sporting events.{" "}
                  <span className="__hide-on-mediam">
                    With more players interacting with your live games, you can
                    generate additional sponsorship and advertising revenue.
                  </span>
                </div>
                <div className="__hide-on-mediam">
                  Live-play Powers are valuable to players! You can sell branded
                  game Powers to{" "}
                  <span className="__primary">generate additional revenue</span>{" "}
                  during live gameplay.
                </div>
                <div>
                  <span className="__hide-on-mediam">
                    Whether you are a casino, state-run gaming operator, media
                    or retail business, or a charity operation...
                  </span>{" "}
                  our live-play game options will power exciting new revenue
                  streams.
                </div>
              </div>
            </div>
          ...
          <div className="__wrapper">
            <div className="__container">
              ...
              <div className="__btn-wrapper">
                <span className="__outine-btn" onClick={() => this.goTo747()}>
